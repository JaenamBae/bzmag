...
namespace agg
{
    ...
    platform_support::platform_support(pix_format_e format, bool flip_y) :
        ...
        m_initial_height(10)
    {
        _tcscpy(m_caption, L"Anti-Grain Geometry Application");
    }
    ...
    //------------------------------------------------------------------------
    void platform_support::caption(const TCHAR* cap)
    {
        _tcscpy(m_caption, cap);
...
*/
    ...
    //------------------------------------------------------------------------
    void platform_support::message(const TCHAR* msg)
    {
        ::MessageBox(m_specific->m_hwnd, msg, L"AGG Message", MB_OK);
    }
