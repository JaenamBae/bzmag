...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	if( !m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CbzmagTreeView), CSize(200,200), pContext) || 
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CbzmagModelerView), CSize(500, 200), pContext) )
	{
